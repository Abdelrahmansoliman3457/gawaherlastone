...
import { mergeProps, resolveComponent, resolveDirective, openBlock, createBlock, Transition, withCtx, createElementBlock, Fragment, renderList, createElementVNode, withDirectives, resolveDynamicComponent, normalizeClass, createCommentVNode, toDisplayString, createVNode } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/vue/index.mjs';
...
var script = {
  ...
  methods: {
    ...
    position: function position() {
      ...
      if (left + width - (void 0).body.scrollLeft > viewport.width) {
        left -= width;
      }
      if (top + height - (void 0).body.scrollTop > viewport.height) {
        top -= height;
      }
      if (left < (void 0).body.scrollLeft) {
        left = (void 0).body.scrollLeft;
      }
      if (top < (void 0).body.scrollTop) {
        top = (void 0).body.scrollTop;
      }
...
//# sourceMappingURL=contextmenu.esm-KjnPgAZN.mjs.map
