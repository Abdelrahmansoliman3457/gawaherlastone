import { hasInjectionContext, inject, version, unref, ref, defineComponent, provide, createElementBlock, defineAsyncComponent, readonly, useSSRContext, h, computed, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, getCurrentInstance, onMounted, mergeProps, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, isReadonly, withCtx, isRef, isShallow, isReactive, toRaw, markRaw } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/vue/index.mjs';
import { $fetch } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/unctx/dist/index.mjs';
import { getRequestHeader, sanitizeStatusCode, setCookie, getCookie, deleteCookie, createError as createError$1, appendHeader } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/ufo/dist/index.mjs';
import destr from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/destr/dist/index.mjs';
import { klona } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/klona/dist/index.mjs';
import { parse } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/cookie-es/dist/index.mjs';
import { isEqual } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/ohash/dist/index.mjs';
import { createPersistedState } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/pinia-plugin-persistedstate/dist/index.mjs';
import { config, library } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/@fortawesome/fontawesome-svg-core/index.mjs';
import { FontAwesomeIcon } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/@fortawesome/vue-fontawesome/index.js';
import { fas } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/@fortawesome/free-solid-svg-icons/index.mjs';
import { createI18n } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/vue-i18n/dist/vue-i18n.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderSlot, ssrRenderStyle } from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/vue/server-renderer/index.mjs';
import MarkerClusterer from 'file://E:/Awamer%20work/my%20projects/Gawaher/Gawaher/node_modules/@googlemaps/markerclustererplus/dist/index.umd.js';
...
const _routes = [
  {
    name: "Titles.aboutUs",
    path: "/aboutUs",
    component: () => import('./aboutUs-DygZlMxq.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.connect_us",
    path: "/connectus",
    component: () => import('./connectus-CEK8fODs.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.exec_msg",
    path: "/executiveMessage",
    component: () => import('./executiveMessage-Dqa3r-dX.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.home",
    path: "/",
    component: () => import('./index-_FHbPDWS.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.jobs",
    path: "/jobs",
    component: () => import('./jobs-DiIFb4Uj.mjs').then((m) => m.default || m)
  },
  {
    name: "news_details.news_details",
    path: "/news-details",
    component: () => import('./news-details-XeQsnUnH.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.news",
    path: "/news",
    component: () => import('./news-BhtVuxyf.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.our_exp",
    path: "/ourExperience",
    component: () => import('./ourExperience-DKzju5Aw.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.our_vision",
    path: "/ourVision",
    component: () => import('./ourVision-BiQ3jpj2.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.trade_mark",
    path: "/trade_mark:id()",
    component: () => import('./trade_mark_id_-w0WFQYnv.mjs').then((m) => m.default || m)
  },
  {
    name: "Titles.trade_marks",
    path: "/tradeMarks",
    component: () => import('./tradeMarks-BnSajRjE.mjs').then((m) => m.default || m)
  }
];
...
const LazyAutoComplete = defineAsyncComponent(() => import('./autocomplete.esm-BBgPQ3S1.mjs').then((r) => r["default"] || r.default || r));
const LazyCalendar = defineAsyncComponent(() => import('./calendar.esm-6xlJ9v7d.mjs').then((r) => r["default"] || r.default || r));
const LazyCascadeSelect = defineAsyncComponent(() => import('./cascadeselect.esm-Do0vvYiG.mjs').then((r) => r["default"] || r.default || r));
const LazyCheckbox = defineAsyncComponent(() => import('./checkbox.esm-B7kTM4pY.mjs').then((r) => r["default"] || r.default || r));
const LazyChips = defineAsyncComponent(() => import('./chips.esm-Duv2ZtH1.mjs').then((r) => r["default"] || r.default || r));
const LazyColorPicker = defineAsyncComponent(() => import('./colorpicker.esm-CIGUtlEs.mjs').then((r) => r["default"] || r.default || r));
const LazyDropdown = defineAsyncComponent(() => import('./dropdown.esm-BJ1dH6Bl.mjs').then((r) => r["default"] || r.default || r));
const LazyFloatLabel = defineAsyncComponent(() => import('./floatlabel.esm-Cvr73zSP.mjs').then((r) => r["default"] || r.default || r));
const LazyIconField = defineAsyncComponent(() => import('./iconfield.esm-B4HH7FKe.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroup = defineAsyncComponent(() => import('./inputgroup.esm-BPBCdrUr.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroupAddon = defineAsyncComponent(() => import('./inputgroupaddon.esm-hf7TZdmO.mjs').then((r) => r["default"] || r.default || r));
const LazyInputIcon = defineAsyncComponent(() => import('./inputicon.esm-t6aIRvii.mjs').then((r) => r["default"] || r.default || r));
const LazyInputMask = defineAsyncComponent(() => import('./inputmask.esm-4k7ijAQf.mjs').then((r) => r["default"] || r.default || r));
const LazyInputNumber = defineAsyncComponent(() => import('./inputnumber.esm-oaTOBw06.mjs').then((r) => r["default"] || r.default || r));
const LazyInputOtp = defineAsyncComponent(() => import('./inputotp.esm-C1k1EVw7.mjs').then((r) => r["default"] || r.default || r));
const LazyInputSwitch = defineAsyncComponent(() => import('./inputswitch.esm-A3KG0xAp.mjs').then((r) => r["default"] || r.default || r));
const LazyInputText = defineAsyncComponent(() => import('./inputtext.esm-36relN0T.mjs').then((r) => r["default"] || r.default || r));
const LazyKnob = defineAsyncComponent(() => import('./knob.esm-CzoLme6w.mjs').then((r) => r["default"] || r.default || r));
const LazyListbox = defineAsyncComponent(() => import('./listbox.esm-Cb2F-bY6.mjs').then((r) => r["default"] || r.default || r));
const LazyMultiSelect = defineAsyncComponent(() => import('./multiselect.esm-CHo-K4jl.mjs').then((r) => r["default"] || r.default || r));
const LazyPassword = defineAsyncComponent(() => import('./password.esm-v-k_mbq8.mjs').then((r) => r["default"] || r.default || r));
const LazyRadioButton = defineAsyncComponent(() => import('./radiobutton.esm-95Is2t9F.mjs').then((r) => r["default"] || r.default || r));
const LazyRating = defineAsyncComponent(() => import('./rating.esm-DE4SnMQt.mjs').then((r) => r["default"] || r.default || r));
const LazySelectButton = defineAsyncComponent(() => import('./selectbutton.esm-BzHi_d0a.mjs').then((r) => r["default"] || r.default || r));
const LazySlider = defineAsyncComponent(() => import('./slider.esm-Baifiq1P.mjs').then((r) => r["default"] || r.default || r));
const LazyTextarea = defineAsyncComponent(() => import('./textarea.esm-iTWykGhZ.mjs').then((r) => r["default"] || r.default || r));
const LazyToggleButton = defineAsyncComponent(() => import('./togglebutton.esm-CLGZNWZu.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeSelect = defineAsyncComponent(() => import('./treeselect.esm-OUH2GeHv.mjs').then((r) => r["default"] || r.default || r));
const LazyTriStateCheckbox = defineAsyncComponent(() => import('./tristatecheckbox.esm-Cp5e1Mho.mjs').then((r) => r["default"] || r.default || r));
const LazyButton = defineAsyncComponent(() => import('./button.esm-C_cw55kj.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonGroup = defineAsyncComponent(() => import('./buttongroup.esm-DoYYN_Wg.mjs').then((r) => r["default"] || r.default || r));
const LazySpeedDial = defineAsyncComponent(() => import('./speeddial.esm-DslC1gqr.mjs').then((r) => r["default"] || r.default || r));
const LazySplitButton = defineAsyncComponent(() => import('./splitbutton.esm-CAe_2i4C.mjs').then((r) => r["default"] || r.default || r));
const LazyColumn = defineAsyncComponent(() => import('./column.esm-PP6KO0wk.mjs').then((r) => r["default"] || r.default || r));
const LazyRow = defineAsyncComponent(() => import('./row.esm-DduDm5kl.mjs').then((r) => r["default"] || r.default || r));
const LazyColumnGroup = defineAsyncComponent(() => import('./columngroup.esm-BAqZWj56.mjs').then((r) => r["default"] || r.default || r));
const LazyDataTable = defineAsyncComponent(() => import('./datatable.esm-DEKEzda-.mjs').then((r) => r["default"] || r.default || r));
const LazyDataView = defineAsyncComponent(() => import('./dataview.esm-DyS0zfe7.mjs').then((r) => r["default"] || r.default || r));
const LazyDataViewLayoutOptions = defineAsyncComponent(() => import('./dataviewlayoutoptions.esm-DyXZOvbT.mjs').then((r) => r["default"] || r.default || r));
const LazyOrderList = defineAsyncComponent(() => import('./orderlist.esm-wYZpc8dc.mjs').then((r) => r["default"] || r.default || r));
const LazyOrganizationChart = defineAsyncComponent(() => import('./organizationchart.esm-DmAngwUv.mjs').then((r) => r["default"] || r.default || r));
const LazyPaginator = defineAsyncComponent(() => import('./paginator.esm-CrWChKM0.mjs').then((r) => r["default"] || r.default || r));
const LazyPickList = defineAsyncComponent(() => import('./picklist.esm-8FX3B5Tf.mjs').then((r) => r["default"] || r.default || r));
const LazyTree = defineAsyncComponent(() => import('./tree.esm-LwlIF41S.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeTable = defineAsyncComponent(() => import('./treetable.esm-DwTRPWBX.mjs').then((r) => r["default"] || r.default || r));
const LazyTimeline = defineAsyncComponent(() => import('./timeline.esm-BerEEAN-.mjs').then((r) => r["default"] || r.default || r));
const LazyVirtualScroller = defineAsyncComponent(() => import('./virtualscroller.esm-CYLd9gUl.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordion = defineAsyncComponent(() => import('./accordion.esm-CFptcT-3.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionTab = defineAsyncComponent(() => import('./accordiontab.esm-Dk0QVHAu.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./card.esm-CxK5fSrS.mjs').then((r) => r["default"] || r.default || r));
const LazyDeferredContent = defineAsyncComponent(() => import('./deferredcontent.esm-Cdisvz85.mjs').then((r) => r["default"] || r.default || r));
const LazyDivider = defineAsyncComponent(() => import('./divider.esm-DodCZ-Cs.mjs').then((r) => r["default"] || r.default || r));
const LazyFieldset = defineAsyncComponent(() => import('./fieldset.esm-D176BIpW.mjs').then((r) => r["default"] || r.default || r));
const LazyPanel = defineAsyncComponent(() => import('./panel.esm-DY0IIUV0.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollPanel = defineAsyncComponent(() => import('./scrollpanel.esm-BUMFDCpb.mjs').then((r) => r["default"] || r.default || r));
const LazySplitter = defineAsyncComponent(() => import('./splitter.esm-BZp6p6Z0.mjs').then((r) => r["default"] || r.default || r));
const LazySplitterPanel = defineAsyncComponent(() => import('./splitterpanel.esm-CANxHihC.mjs').then((r) => r["default"] || r.default || r));
const LazyStepper = defineAsyncComponent(() => import('./stepper.esm-BFLqIPcN.mjs').then((r) => r["default"] || r.default || r));
const LazyStepperPanel = defineAsyncComponent(() => import('./stepperpanel.esm-C47K0C_A.mjs').then((r) => r["default"] || r.default || r));
const LazyTabView = defineAsyncComponent(() => import('./tabview.esm-DFKHjA-R.mjs').then((r) => r["default"] || r.default || r));
const LazyTabPanel = defineAsyncComponent(() => import('./tabpanel.esm-BGFUcJO4.mjs').then((r) => r["default"] || r.default || r));
const LazyToolbar = defineAsyncComponent(() => import('./toolbar.esm-BjyOryYo.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmDialog = defineAsyncComponent(() => import('./confirmdialog.esm-DHph6wmL.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmPopup = defineAsyncComponent(() => import('./confirmpopup.esm-D_QO1L3u.mjs').then((r) => r["default"] || r.default || r));
const LazyDialog = defineAsyncComponent(() => import('./dialog.esm-BvBVo1Rn.mjs').then((r) => r["default"] || r.default || r));
const LazyDynamicDialog = defineAsyncComponent(() => import('./dynamicdialog.esm-DenLgJrP.mjs').then((r) => r["default"] || r.default || r));
const LazyOverlayPanel = defineAsyncComponent(() => import('./overlaypanel.esm-BPPoMYH2.mjs').then((r) => r["default"] || r.default || r));
const LazySidebar = defineAsyncComponent(() => import('./sidebar.esm-DEK1fej2.mjs').then((r) => r["default"] || r.default || r));
const LazyFileUpload = defineAsyncComponent(() => import('./fileupload.esm-DzMRSKjh.mjs').then((r) => r["default"] || r.default || r));
const LazyBreadcrumb = defineAsyncComponent(() => import('./breadcrumb.esm-BY4g-TBW.mjs').then((r) => r["default"] || r.default || r));
const LazyContextMenu = defineAsyncComponent(() => import('./contextmenu.esm-KjnPgAZN.mjs').then((r) => r["default"] || r.default || r));
const LazyDock = defineAsyncComponent(() => import('./dock.esm-CIRP99zx.mjs').then((r) => r["default"] || r.default || r));
const LazyMenu = defineAsyncComponent(() => import('./menu.esm-CBn3AkR7.mjs').then((r) => r["default"] || r.default || r));
const LazyMenubar = defineAsyncComponent(() => import('./menubar.esm-DhnNTGKw.mjs').then((r) => r["default"] || r.default || r));
const LazyMegaMenu = defineAsyncComponent(() => import('./megamenu.esm-CCopWM-_.mjs').then((r) => r["default"] || r.default || r));
const LazyPanelMenu = defineAsyncComponent(() => import('./panelmenu.esm-BlAJEiXH.mjs').then((r) => r["default"] || r.default || r));
const LazySteps = defineAsyncComponent(() => import('./steps.esm-BoEiIAkA.mjs').then((r) => r["default"] || r.default || r));
const LazyTabMenu = defineAsyncComponent(() => import('./tabmenu.esm-DB-1b-Sb.mjs').then((r) => r["default"] || r.default || r));
const LazyTieredMenu = defineAsyncComponent(() => import('./tieredmenu.esm-DJPNOnlB.mjs').then((r) => r["default"] || r.default || r));
const LazyMessage = defineAsyncComponent(() => import('./message.esm-DhKah7XD.mjs').then((r) => r["default"] || r.default || r));
const LazyInlineMessage = defineAsyncComponent(() => import('./inlinemessage.esm-X2gA_m1o.mjs').then((r) => r["default"] || r.default || r));
const LazyToast = defineAsyncComponent(() => import('./toast.esm-Ck6Ysh0B.mjs').then((r) => r["default"] || r.default || r));
const LazyCarousel = defineAsyncComponent(() => import('./carousel.esm-t1mjqPug.mjs').then((r) => r["default"] || r.default || r));
const LazyGalleria = defineAsyncComponent(() => import('./galleria.esm-Dt78IG1F.mjs').then((r) => r["default"] || r.default || r));
const LazyImage = defineAsyncComponent(() => import('./image.esm-BS_tcCwI.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatar = defineAsyncComponent(() => import('./avatar.esm-CKDA0Qqf.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatarGroup = defineAsyncComponent(() => import('./avatargroup.esm-DsZhFEx3.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./badge.esm-DqS6Ol5z.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockUI = defineAsyncComponent(() => import('./blockui.esm-4H_KDG6U.mjs').then((r) => r["default"] || r.default || r));
const LazyChip = defineAsyncComponent(() => import('./chip.esm-D9PG8cN_.mjs').then((r) => r["default"] || r.default || r));
const LazyInplace = defineAsyncComponent(() => import('./inplace.esm-Bsib7eSX.mjs').then((r) => r["default"] || r.default || r));
const LazyMeterGroup = defineAsyncComponent(() => import('./metergroup.esm-CHHV7Fpx.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollTop = defineAsyncComponent(() => import('./scrolltop.esm-C_7SMovD.mjs').then((r) => r["default"] || r.default || r));
const LazySkeleton = defineAsyncComponent(() => import('./skeleton.esm-D_czaoGO.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressBar = defineAsyncComponent(() => import('./progressbar.esm-BEuguu5z.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressSpinner = defineAsyncComponent(() => import('./progressspinner.esm-DFUoTJjg.mjs').then((r) => r["default"] || r.default || r));
const LazyTag = defineAsyncComponent(() => import('./tag.esm-D8NI9Y3V.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./terminal.esm-CCx9kqEq.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  custom: () => import('./custom-c3tP8XcR.mjs').then((m) => m.default || m),
  default: () => import('./default-Db5f1CBE.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-8ICYvNEE.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DGoWMcvo.mjs').then((r) => r.default || r));
...
export { BaseStyle as B, ConnectedOverlayScrollHandler as C, DomHandler as D, FocusTrap as F, ObjectUtils as O, Ripple as R, ToastEventBus as T, UniqueComponentId as U, ZIndexUtils as Z, _export_sfc as _, useToast as a, useRouter as b, navigateTo as c, useRuntimeConfig as d, entry$1 as default, resolveUnrefHeadInput as e, useStyle as f, FilterService as g, Tooltip as h, injectHead as i, _default as j, FilterOperator as k, FilterMatchMode as l, ConfirmationEventBus as m, nuxtLinkDefaults as n, DynamicDialogEventBus as o, primebus as p, useCookie as q, resolveRouteObject as r, useNuxtApp as s, useRoute as u };
